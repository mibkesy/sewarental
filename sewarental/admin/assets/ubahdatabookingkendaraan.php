...
<head>
    ...
    <title>Change Booking Data Vehicle</title>
    <!-- Font Awesome-->
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                ...
                                <div class="col card-header text left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Ubah Data Booking Kendaraan</h1>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="container">
                                    <form action="prosesubahdatabookingkendaraan.php" method="post" encytype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-sm-19">
                                                <div class="form-group">
                                                    <label for="kode_booking">Kode Booking</label>
                                                    <input type="text" class="form-control" name="kode_booking" value="" placeholder="Enter Booking Code">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" class="form-control" name="lama_sewa" value="" placeholder="Enter Length of Lease">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tanggal">Tanggal</label>
                                                    <input type="date" class="form-control" name="tanggal" value="" placeholder="Enter Date">
                                                </div>
                                                <div class="form-group">
                                                    <label for="tanggal_input">tanggal input</label>
                                                    <input type="date" class="form-control" name="tgl_input" value="" placeholder="Enter Input Date">
                                                </div>
                                                <div class="form-group">
                                                    <label for="total_harga">Total Harga</label>
                                                    <input type="number" class="form-control" name="total_harga" value="" placeholder="Enter Total Price">
                                                </div>
                                                <button type="submit" class="btn btn-info btn-block" onClick="return confirm('This data have been already changed!')"><i class="fa fa-edit"></i>&nbsp;Change</button>
