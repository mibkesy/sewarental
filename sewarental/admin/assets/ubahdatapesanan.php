...
<head>
    ...
    <title>Change Orderv Vehicle Data</title>
    <!-- Font Awesome-->
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Change Order Vehicle Data</h1>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="card-shadow">
                                    <div class="card-header">
                                        <h1 class="h1 mb-5 font-weight-bold text-primary">Change Order Vehicle Data</h1>
                                    </div>
                                    <div class="card-body">
                                        <form action="prosesubahpesanankendaraan.php" method="post" encytype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="harga">Harga</label>
                                            <input type="number" name="harga" require="required" placeholder="Enter Price" class="form-control" value="">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="tgl_pinjam">Tanggal Pinjam</label>
                                            <input type="date" name="tgl_pinjam" require="required" placeholder="Enter Loan Date" class="form-control" value="">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="tgl_kembali">Tanggal Kembali</label>
                                            <input type="date" name="tgl_kembali" require="required" placeholder="Enter Back Date" class="form-control" value="">
                                        </div>
                                            <button type="submit" class="btn btn-success btn-block" name="change" onClick="return cofirm('This data have been already changed')"><i class="fa fa-edit"></i>&nbsp;Change</button>
