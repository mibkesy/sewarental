                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">User Data</h1>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-19">
                            <div class="card-shadow">
                                ...
                                <div class="card-body">
                                    <form action="prosestambahuser.php" method="post" encytype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" class="form-control" value="" placeholder="Enter Password Confirmation">
                                        </div>
                        ...
                        <div class="col-sm-19">
                            <div class="card-shadow">
                                <div class="card-header">
                                    <h1 class="h1 mb-5 font-weight-bold text-primary">Daftar Pengguna</h1>
                                </div>
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable" width="" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($tbluser)) :
                                            ?>
                                             <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $data['username']; ?></td>
                                                <td><?= $data['email']; ?></td>
                                                <td><?= $data['password']; ?></td>
                                                <td><?= $data['password_conf']; ?></td>
                                                <td>
                                                    <a href="ubahuser.php?id=<?= $data['id_user']; ?>" class="btn btn-info"><i class="fa fa-edit"></i>&nbsp;Change</a>
                                                    <a href="hapususer.php?id=<?= $data['id_user']; ?>" class="btn btn-danger" onClick="return confirm('Are you sure want to delete this data!')"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
