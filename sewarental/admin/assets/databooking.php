                    ...
                    <div class="col-sm-19">
                        <div class="clearfix">
                            ...
                            <div class="col card-header text-left">
                                <h1 class="h1 mb-5 font-weight-bold text-gray-900">Booking Vehicle Data</h1>
                            </div>
                            <div class="col card-header text-right">
                                <a href="tambahdatabookingkendaraan.php" class="btn btn-success float-end"><i class="fa fa-plus"></i>&nbsp;Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    include("koneksi.php");
                                    $sql="SELECT * FROM  tblbooking WHERE id_booking";
                                    $no=1;
                                    $tblbooking = mysqli_query($koneksi,"SELECT * FROM tblbooking WHERE id_booking");
                                    while ($data = mysqli_fetch_array($tblbooking)) :
                                    ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        ...
                                        <td><?= $data['total_harga']; ?>Rp. <?php echo number_format($isi['total_harga']); ?></td>
                                        <td><?= $data['konfirmasi_pembayaran']; ?></td>
                                        <td>
                                            <a href="ubahdatabookingkendaraan.php?id=<?= $data['id_booking']; ?>" class="btn btn-primary "><i class="fa fa-edit"></i>&nbsp;Change</a>
                                            <a href="hapusbooking.php?id=<?= $data['id_booking']; ?>" class="btn btn-danger" role="button"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                                </tbody>
