...
<head>
    ...
    <title>Vehicle Return Data</title>
    <!-- Font Awesome-->
                    ...
                    <div class="col-sm-19">
                        <div class="clearfix">
                            <div class="float-left">
                                <h1 class="h1 mb-5 font-weight-bold text-gray-900">Vehicle Return Data</h1>                                
                            </div>
            ...
            <div class="row">
                <div class="col-sm-19">
                    <div class="card-shadow">
                        ...
                        <div class="card-body">
                            <form action="prosestambahkembalikendaraan.php" method="post" encytype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggalsewa" class="form-control" value="" placeholder="Enter Sewa">
                                </div>
                                <div class="form-group">
                                    <label for="tgl_kembali">Tanggal Kembali</label>
                                    <input type="date" name="tanggalkembali" class="form-control" value="" placeholder="Enter Kembali">
                                </div>
                ...
                <div class="col-sm-19">
                    <div class="card-shadow">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered" width="" cellspacing="">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Denda</th>
                                ...
                                <?php
                                    include("koneksi.php");
                                    $sql="SELECT * FROM tblkembali WHERE id_kembali";
                                    $no=1;
                                    $tblkembali = mysqli_query($koneksi,"SELECT * FROM tblkembali WHERE id_kembali");
                                    while ($data = mysqli_fetch_array($tblkembali)) :
                                    ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $data['denda']; ?></td>
                                        ...
                                        <td>
                                            <a href="ubahkembalikendaraan.php?id=<?= $data['id_kembali']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Change</a>
                                            <a href="hapuskembalikendaraan.php?id=<?= $data['id_kembali']; ?>" class="btn btn-danger" onClick="return confirm('Are you sure want to delete this data!')"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                    </tr>
                                <?php endwhile; ?>
                                </tbody>
                            </table>
