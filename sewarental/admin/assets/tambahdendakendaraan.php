...
<head>
    ...
    <title>Add Vehicle Fine Data</title>
    <!-- Font Awesome-->
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                ...
                                <div class="col card-header text left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Add Vehicle Fine Data</h1>
                                            ...
                                            <div class="card-body">
                                                <div class="card-shadow">
                                                    <div class="card-header">
                                                        <h1 class="h1 mb-5 font-weight-bodl text-primary">Add Data</h1>
                                                    </div>
                                                    <div class="card-body">
                                                        <form action="prosestambahdendakendaraan.php" method="psot" encytype="multipart/form-data">
                                                            ...
                                                            <button type="submit"  class="btn btn-success btn-block" name="" onClick="return confirm('This data have been already added!')"><i class="fa fa-plus"></i>&nbsp;Save</button>
