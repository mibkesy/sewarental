                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                ...
                                <div class="col card-header text-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Customer Data</h1>
                                </div>
                                <div class="col card-header text-right">
                                    <a href="tambahpelanggan.php" class="btn btn-success float-end"><i class="fa fa-plus"></i>&nbsp;Add</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        include("koneksi.php");
                                        $sql="SELECT * FROM `tblpelanggan` WHERE id_pelanggan";
                                        $no=1;
                                        $tblpelanggan = mysqli_query($koneksi,"SELECT * FROM tblpelanggan WHERE id_pelanggan");
                                        while ($data = mysqli_fetch_array($tblpelanggan)) : 
                                        ?>                                        
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $data['nama']; ?></td>
                                            ...
                                            <td>
                                                <a href="ubahdatapelanggan.php?id=<?= $data['id_pelanggan']; ?>" class="btn btn-warning"><i class="fa fa-edit"></i>&nbsp;Change</a>
                                                <a href="hapuspelanggan.php?id=<?= $data['id_pelanggan']; ?>" class="btn btn-danger" onClick="return confirm('Are you sure want to delete this data!')"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
