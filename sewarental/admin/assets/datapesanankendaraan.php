...
<head>
    ...
    <title>Data Pesanan Kendaraan</title>
    <!-- Font Awesome-->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 text-gray-900">Data Pesanan Kendaraan</h1>
                                </div>
                                <div class="col card-header text-right">
                                    <a href="index.php" class="btn btn-secondary float-end"><i
                    ...
                    <div class="row">
                        <div class="col-sm-19">
                            <div class="card-shadow">
                                ...
                                <div class="card-body">
                                    <form action="prosestambahpesanankendaraan.php" method="post"
                                        encytype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="harga">Harga</label>
                                            <input type="number" name="harga" require="required"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_pinjam" require="required"
                                                placeholder="Enter Loan Date" class="form-control"
                                                value="">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="tgl_kembali">Tanggal Kembali</label>
                                            <input type="date" name="tgl_kembali" require="required"
                                                placeholder="Enter Back Date" class="form-control"
                                                value="">
                                        </div>
                                        <button type="submit" class="btn btn-success btn-block" name="add"><i
                                                class="fa fa-plus"></i>&nbsp;Add</button>
                                        <button type="reset" class="btn btn-danger btn-block" name="cancel"><i
                    ...
                    <div class="col-sm-19">
                        <div class="card-shadow">
                            <div class="card-header">
                                <h1 class="m-0 font-weight-bold text-gray-900">Daftar Pesanan</h1>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered" id="dataTable" width="" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            include("koneksi.php");
                                            $sql="SELECT * FROM tblpesanan WHERE id_pesanan";
                                            $no=1;
                                            $tblpesanan=mysqli_query($koneksi,"SELECT * FROM tblpesanan");
                                            while ($data = mysqli_fetch_array($tblpesanan)) : 
                                            ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $data['harga']; ?></td>
                                            ...
                                            <td>
                                                <a href="ubahdatapesanan.php?id=<?= $data['id_pesanan']; ?>" class="btn btn-info"><i
                                                        class="fa fa-edit"></i>&nbsp;Change</a>
                                                <a href="hapuspesanan.php?id=<?= $data['id_pesanan']; ?>" class="btn btn-danger"
