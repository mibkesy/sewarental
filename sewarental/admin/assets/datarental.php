                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Renting Car Data</h1>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-19">
                            <div class="card-shadow">
                                ...
                                <div class="card-body">
                                    <form action="prosestambahrental.php" method="post" encytype="multipart/form-data">
                        ...
                        <div class="col-sm-19">
                            <div class="card-shadow">
                                <div class="card-header">
                                    <h1 class="h1 mb-5 font-weight-bold text-primary">List Renting</h1>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
                                            include("koneksi.php");
                                            $sql="SELECT * FROM tblrental WHERE id_rental";
                                            $no=1;
                                            $tblrental = mysqli_query($koneksi,"SELECT * FROM tblrental WHERE id_rental");
                                            while ($data = mysqli_fetch_array($tblrental)) : 
                                            ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $data['jumlah']; ?></td>
                                                <td><?= $data['tgl_pinjam']; ?></td>
                                                 <td>
                                                    <a href="ubahdatarental.php?id=<?= $data['id_rental']; ?>" class="btn btn-info"><i class="fa fa-edit"></i>&nbsp;Change</a>
                                                    <a href="hapusrental.php?id=<?= $data['id_rental'];?>" class="btn btn-danger" onClick="return confirm('Are you sure want to delete this data!')"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                        </tbody>
