...
<head>
    ...
    <title>Change Officer Data</title>
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-900">Change Officer Data</h1>
                                </div>
                                <div class="col card-header text-right">
                                    <a href="#" class="btn btn-secondary" onClick="return confirm('Are you sure want to back!')"><i class="fa fa-reply"></i>Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="card-shadow">
                                        <div class="card-header">
                                            <h1 class="h1 mb-5 font-weight-bold text-primary">Change Officer Data</h1>
                                        </div>
                                        <div class="card-body">
                                            <form action="prosesubahdatapetugas.php" method="post" encytype="multipart/form-data">
                                                <div class="form-group">
                                                    <label for="nama_petugas">Nama Petugas</label>
                                                    <input type="text" name="nama_petugas" class="form-control" value="" placeholder="Enter Officer Name">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="no_telp" class="form-control" value="" placeholder="Enter Cellphone">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button type="reset" class="btn btn-danger btn-block" onClick="return confirm('This data have been canceled!')"><i class="fa fa-times"></i>&nbsp;Cancel</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
