                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                ...
                                <div class="col card-header text left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Ubah Data Perjalanan</h1>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="container">
                                    <form action="prosesubahdataperjalanan.php" method="post" encytype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tujuan" value="" placeholder="Enter Destination">
                                                </div>
                                                <div class="form-group">
