...
<head>
    ...
    <title>Change Vehicle Returns Data</title>
    <!-- Font Awesome-->
                    ...
                    <div class="col-sm-19">
                        <div class="clearfix">
                            <div class="float-left">
                                <h1 class="h1 mb-5 font-weight-bold text-gray-900">Change Vehicle Returns Data</h1>
                            </div>
                            <div class="col card-header">
                                <a href="index.php" class="btn btn-secondary float-end" onClick="return confirm('Are you sure you want to back!')"><i class="fa fa-reply"></i>&nbsp;Back</a>
                            </div>
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="card-shadow">
                        <div class="card-header">
                            <h1 class="h1 m-1 font-weight-bold text-primary-900">Change Vehicle Returns Data</h1>
                        </div>
                        <div class="card-body">
                            <form action="prosesubahpengembaliankendaraan.php" method="post" encytype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block" name="ubah" onClick="return confirm('This data have been changed!')"><i class="fa fa-edit"></i>&nbsp;Change</button>
