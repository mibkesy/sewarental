...
<body class="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <div class="container-fluid">
                    <h1 class="h1 mb-5 text-gray-900">Dashboard</h1>
                    <hr>
                    <div class="row">
                            ...
                            <div class="card-border left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-mr-3">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-2">Data Kendaraan</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-900">Kendaraan</div>
                                        </div>
                                        <div class="col-auto">
                                        <i class="fa fa-car 8x text-primary"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-7 mb-5">
                            <div class="card-border left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-mr-3">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-2">Data Paket</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-900">Paket</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-book 8x text-primary"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-7 mb-5">
                            <div class="card-border left-info shadow h-100 py2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-mr-3">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-2">Data Pesanan</div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h1 mb-0 mr-4 font-weight-bold text-gray-900">Pesanan</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-receipt 8x text-primary"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-7 mb-5">
                            <div class="card-border left warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-mr-3">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-2">Manajemen Akun</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-900">Akun</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa fa-user 8x text-primary"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <a href="index.php" class="scroll-to-top rounded">
