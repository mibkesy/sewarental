...
<head>
    ...
    <title>Change Vehicle Fine Data</title>
    <!-- Font Awesome-->
                            ...
                            <div class="clearfix">
                                <div class="float-left">
                                    ...
                                    <div class="col card-header text left">
                                        <h1 class="h1 mb-5 font-weight-bold text-gray-900">Change Vehicle Fine Data</h1>
                                                ...
                                                <div class="card-body">
                                                    <div class="card-shadow">
                                                        <div class="card-header">
                                                            <h1 class="h1 mb-5 font-weight-bodl text-primary">Change Data</h1>
                                                        </div>
                                                    <div class="card-body">
                                                        <form action="prosesubahdendakendaraan.php" method="psot" encytype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label for="denda">Denda</label>
                                                            <input type="number" class="form-control" name="denda" placeholder="Enter Denda">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="bayar">Bayar</label>
                                                            <input type="number" class="form-control" name="bayar" placeholder="Enter Bayar">
                                                        </div>
                                                        <button type="submit"  class="btn btn-success btn-block" name="" onClick="return confirm('This data have been already changed!')"><i class="fa fa-edit"></i>&nbsp;Change</button>
