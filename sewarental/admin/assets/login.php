                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h1 text-gray-900 mb-5">Login</h1>
                                    </div>
                                    <form action="login-act.php" method="post" encytype="multipart/form-data">
                                    <form action="proses-login.php" method="post" encytype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block" onClick="return confirm('Are you sure want to sign in!')"> <i class="fa fa-sign-in-alt"></i>&nbsp;Login<button><a href="register.php">Register</a>
                                        </form>
                                        </form>
                                    </form>
                                 </div>
