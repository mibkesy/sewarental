...
<head>
    ...
    <title>Add Booking Data Vehicle</title>
    <!-- Font Awesome-->
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                ...
                                <div class="col card-header text left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Tambah Data Booking Kendaraan</h1>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="container">
                                    <form action="prosestambahbookingkendaraan.php" method="post" encytype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-sm-19">
                                                ...
                                                <button type="submit" class="btn btn-success btn-block" onClick="return confirm('This data have been already added!')"><i class="fa fa-plus"></i>&nbsp;Save</button>
