...
<head>
    ...
    <title>Change Order Data  Vehicle</title>
    <!-- Font Awesome-->
                            ...
                            <div class="clearfix">
                                <div class="float-left">
                                    <div class="col card-header text-left">
                                        <h1 class="h1 mb-5 font-weight-bold text-gray-900">Ubah Data Pemesanan Kendaraan</h1>
                                    </div>
                                    <br>
                    ...
                    <div class="col-sm-19">
                        <div class="card-shadow">
                            <div class="card-header">
                                <h1 class="h1 m-0 font-weight-bold text-primary">Ubah Data Pemesanan Kendaraan</h1>
                            </div>
                            <div class="card-body">
                                <form action="prosesubahpemesan.php" method="post" encytype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <b>Maaf, ukuran foto wajib harus 300pxX300px</b>
                                    </div>
                                    <br>
                                        <button type="submit" class="btn btn-primary btn-block" name="ubah" value="ubah" onClick="return confirm('This data have been already changed!')"><i class="fa fa-edit"></i>&nbsp;Change</button>
                                        <button type="reset" class="btn btn-danger btn-block" name="batal" value="batal" onClick="return confirm('This data have been already canceled!')"><i class="fa fa-times"></i>&nbsp;Cancel</button>
                                    </div>
                                </form>
                            </div>                            
                        </div>
