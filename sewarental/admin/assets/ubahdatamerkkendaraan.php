...
<head>
    ...
    <title>Change Brand Data Vehicle</title>
    <!-- Font Awesome-->
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray-900">Ubah Data Merk Kendaraan</h1>
                                </div>
                                <br><br>
                    ...
                    <div class="col-sm-19">
                        <div class="card-shadow">
                            <div class="card-header">
                                <h1 class="h1 m-1 font-weight-bold text-primary-900">Ubah Data Merk Kendaraan</h1>
                            </div>
                            <div class="card-body">
                                <form action="prosesubahmerkkendaraan.php" method="post" encytype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="merk">Merk</label>
                                        <input type="text" class="form-control" name="merk" id="merk" value="" autocomplete="off" placeholder="Enter Brand">
                                    </div>
                                        <button type="sumbit" class="btn btn-info btn-block" onClick="return confirm('This data have been already changed!')"><i class="fa fa-edit"></i>&nbsp;Change</button>
