...
<head>
    ...
    <title>Change Rental Data Vehicle</title>
    <!-- Font Awesome-->
                        ...
                        <div class="col-sm-19">
                            <div class="clearfix">
                                <div class="float-left">
                                    <h1 class="h1 mb-5 font-weight-bold text-gray900">Change Rental Data Vehicle</h1>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="card-shadow">
                                        <div class="card-header">
                                            <h1 class="h1 mb-5 font-weight-bold text-primary">Change Rental Data Vehicle</h1>
                                        </div>
                                        <div class="card-body">
                                            <form action="prosesubahrental.php" method="post" encytype="multipart/form-data">
