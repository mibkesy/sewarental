...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="vendor/fontawesome-free/css/brands.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="vendor/fontawesome-free/css/svg-with-js.min.js">
    ...
    <link rel="stylesheet" type="text/css" href="vendor/font-awesome/css/fontawesome.min.css">
    <link rel="stylesheet" type="text/css" href="vendor/fontawesome-free/css/all.min.css">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h1 text-gray-900 mb-5">Register</h1>
                                    </div>
                                    <form action="register-act.php" method="post" encytype="multipart/form-data">
                                    <form action="proses-register.php" method="post" encytype="multipart/form-data" class="user">
                                        <div class="form-group">
                                            <strong><label for="username">Username</label></strong>
                                            <i class="fa fa-user"></i><input type="text" name="username" class="form-control form-control-user" placeholder="Enter Username">
                                        </div>
                                        <div class="form-group">
                                            <strong><label for="password">Password</label></strong>
                                            <i class="fa fa-lock"></i><input type="password" name="password" class="form-control form-control-user" placeholder="Enter Password">
                                        </div>
                                        <div class="form-group">
                                            <strong><label for="password">Konfirmasi Password</label></strong>
                                            <i class="fa fa-lock"></i><input type="password" name="password" class="form-control form-control-user" placeholder="Enter Password">
                                        </div>
                                        <div class="form-group">
                                            <strong><label for="email">Email</label></strong>
                                            <i class="fa fa-envelope"></i><input type="email" name="email" class="form-control form-control-user" placeholder="Enter Email">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block" onClick="return confirm('Congratulation, you're have been already registered!')"><i class="fa fa-sign-out-alt"></i>&nbsp;Register</button><a href="login.php">Login</a>
                                        <hr>
                                        </form>
                                    </form>
                                 </div>
